...
class TestWrap(unittest.TestCase):
    ...
    def test_to_decimal(self):
        ...
        ra_new, dec_new = wp.to_decimal(ra, dec)
    ...
    def test_create_cs(self):
        ...
        ra, dec = '00 43 28.40', '+64 45 35.40' 
        # RA and DEC for WR1 in hms, dms. 
        ra_new, dec_new, c = wp.create_cs([ra], [dec])
    ...
    def test_conv_to_galactic(self):
        ...
        # WR106
        l, b = wp.conv_to_galactic(ra, dec) 
    ...
    def test_standardize_coords(self):
        ...
        # RA and DEC for WR1 in hms, dms. 
        ra_new, dec_new = wp.to_decimal(ra, dec, pres=7)
        ra_proc, dec_proc = wp.standardize_coords(ra_new, dec_new)
    ...
    def test_most_recent(self):
        ...
        wrecent = wp.most_recent(wr_type, ref)
